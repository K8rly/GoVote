...
6. [Generation Breakdown](#Generation-Breakdown)
7. [Technologies](#technologies-languages-tools-and-algorithms-used-throughout-the-project)
8. [Database Integration](#Database-Integration)
9. [Schema](#Schema)
10. [Entity Relationship Diagram (ERD)](#Entity-Relationship-Diagram)
11. [Machine Learning Model](#Machine-Learning-Model)
12. [Results of the Analysis](#Results-of-the-Analysis)
...
#### Topic
  Analyzing voter registration and election results in Cuyahoga County by Age, Zip Code, and party in order to determine trends in voting patterns
...
#### Tableau Dashboard Link [Here](https://public.tableau.com/app/profile/leiana.sulecki/viz/shared/FKZYSWCKN)
